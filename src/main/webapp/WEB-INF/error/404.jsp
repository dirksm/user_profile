...
<div class="form-container padding-bottom-sm padding-top-sm error-page-form-container">
	<h2 class="404">Page is not available</h2>
	<div class="row">
	...
	<div class="row">
		<div class="col-md-12">
            ...
            <ul>
                <li>the page you're looking for may have been moved, updated or deleted, or</li>
                <li>you may have mistyped the web address incorrectly.</li>
            </ul>		
		</div>
	</div>
</div>